...
{
    while (fuc_Length--) *(fucp_SaveArr++) = *((unsigned char code*)(fui_Address++));  // 读取数据
}
...
//    sprintf(guc_Uartbuf_p,"功能1\r\n");
}


/***************************************************************************************
 * @说明  	功能：修改指定通道电压参数 的回调函数
 * @参数    无
 * @返回值  无
 * @注      无
 ***************************************************************************************/
...
//    sprintf(guc_Uartbuf_p,"功能2\r\n");
}

/***************************************************************************************
 * @说明  	功能：指定PWM波实现管脚，频率和占空比 的回调函数
 * @参数    无
 * @返回值  无
 * @注      无
 ***************************************************************************************/
...
void callback_ModifyPWMParameter(unsigned char *myStr)
{
    ...
    unsigned int      PWMCycle = 0, PWMDutycycle = 0;  // PWMCycle - 存放PWM波的周期  PWMDutycycle - 存放PWM占空比的具体数值
...
//    sprintf(guc_Uartbuf_p,"功能3\r\n");
}

/***************************************************************************************
 * @说明  	功能：指定PWM输出周期和工作时间 的回调函数
 * @参数    无
 * @返回值  无
 * @注      无
 ***************************************************************************************/
